...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Nouveau nouveau=HandyManUtils.fromJson(Nouveau.class, HandyManUtils.getFileContent(Constantes.NOUVEAU_JSON));
        Database database;
        Language language;
        ...
        try(Scanner scanner=new Scanner(System.in)){
            ...
            try(Connection connect=database.getConnexion(credentials)){
                ...
                nouveau.changementAppMain(entities, projectName);
            }catch(Exception e) {
                e.printStackTrace();
            }
